    ...
    <div className={classes.root}>
      <div className={classes.smallPrintContainer}>
        <Typography className={classes.font}>
          ...
          license from Microsoft. This was a really fun challenge so thank you
          for that lol. The rating icon is a registered trademark of the Pan
          European Game Information. All other trademarks are the property of
